                        ...
                        <div className="relative w-48 h-48 flex-shrink-0">
                            <svg className="transform -rotate-90 w-48 h-48">
                                ...
                                <circle
                                    ...
                                    strokeDashoffset={`${2 * Math.PI * 88 * (1 - stats.completion / 100)}`}
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                <span className="text-5xl font-bold text-accent">{stats.completion}%</span>
                                <span className="text-sm text-ink-500 font-medium mt-1">Complétude</span>
                            </div>
                        </div>
